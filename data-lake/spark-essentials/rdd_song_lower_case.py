...
# Spark in local mode on your computer.
#
###
...
# which is the entry point to programming Spark with the DataFrame API.
...
# foreach() function is used to print each element in the RDD distributed_song_log_rdd
#print("Type of rdd is", type(distributed_song_log_rdd))
#distributed_song_log_rdd.foreach(print)

#create function that converts a given song title to lowercase.
